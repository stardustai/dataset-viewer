...
export const DataTableCell: React.FC<DataTableCellProps> = memo(
  ({ value, column, rowIndex, onOpenModal }) => {
    ...
    return (
      <div ref={contentRef} className="flex items-center w-full min-w-0">
        <div
          data-text-content
          className={`data-table-cell ${className} text-sm flex-1 min-w-0 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 rounded px-1 py-0.5 transition-colors`}
