export const connection = {
  ...
  'ssh.server.placeholder': '192.168.1.100 or server.domain.com',
  'ssh.server.description': 'IP address or hostname of the SSH server',
  'ssh.port': 'SSH Port',
  'ssh.port.placeholder': '22',
  'ssh.port.description': 'SSH service port (default: 22)',
  'ssh.username': 'SSH Username',
  'ssh.username.placeholder': 'username',
  'ssh.username.description': 'SSH login username',
  'ssh.password': 'SSH Password',
  'ssh.password.placeholder': 'password',
  'ssh.password.description': 'SSH login password',
  'ssh.private.key': 'SSH Private Key File',
  'ssh.private.key.placeholder': 'private key file path',
  'ssh.private.key.description': 'SSH private key file path (optional, private key takes priority)',
  'ssh.passphrase': 'Private Key Passphrase',
  'ssh.passphrase.placeholder': 'private key passphrase',
  'ssh.passphrase.description': 'Passphrase for decrypting the private key file (if needed)',
  'ssh.path': 'Remote Path',
  'ssh.path.placeholder': '/home/username',
  'ssh.path.description': 'Directory path on the remote server',
