export const connection = {
  ...
  'app.tagline': 'Easily manage your cloud files',
  'app.description': 'Cross-platform file browser supporting WebDAV, object storage, and local file systems with powerful features like streaming and virtual scrolling.',

  // Features
  'features.title': 'Core Features',
  'features.large_files': 'Large File Support',
  'features.large_files.desc': 'Stream 100GB+ files with chunked loading',
  'features.archive_preview': 'Archive Preview',
  'features.archive_preview.desc': 'Stream ZIP/TAR files without extraction',
  'features.virtual_scrolling': 'Virtual Scrolling',
  'features.virtual_scrolling.desc': 'Efficiently handle millions of lines',
  'features.multi_storage': 'Multi Storage Support',
  'features.multi_storage.desc': 'Support WebDAV, OSS and local file systems',
