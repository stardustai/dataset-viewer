export const fileViewer = {
  ...
  'pcd.error.binaryNotSupported': 'Binary format PCD files are not currently supported',
  'pcd.error.noValidPoints': 'No valid point cloud data found',
  'pcd.error.loadFailed': 'Failed to load PCD file',
  'pcd.hideStats': 'Hide Statistics',
  'pcd.showStats': 'Show Statistics',
  'pcd.settings': 'Settings',
  'pcd.stopRotation': 'Stop Rotation',
  'pcd.startRotation': 'Start Rotation',
  'pcd.resetView': 'Reset View',
  'pcd.zoomIn': 'Zoom In',
  'pcd.zoomOut': 'Zoom Out',
  'pcd.statistics': 'Statistics',
  'pcd.pointCount': 'Point Count',
  'pcd.hasColor': 'Has Color',
  'pcd.hasIntensity': 'Has Intensity',
  'pcd.bounds': 'Bounds',
  'pcd.renderSettings': 'Render Settings',
  'pcd.pointSize': 'Point Size',
  'pcd.colorMode': 'Color Mode',
  'pcd.colorMode.rgb': 'RGB Color',
  'pcd.colorMode.intensity': 'Intensity',
  'pcd.colorMode.height': 'Height',
  ...
  'pcd.pointsLimited': 'Showing first {{maxPoints}} points (of {{totalPoints}} total)',
