export const settings = {
  ...
  'pure.black.background': 'Pure Black Background',
  ...
  'file.associations.capability.success':
    'File capability registered successfully (not as default handler)',
  ...
  'file.association.advanced.description':
    'Choose which file types you want this application to handle. Only selected extensions will be registered as associations.',
  ...
  cancel: 'Cancel',
  warning: 'Warning', // File categories
  ...
  'file.extension.problematic.warning':
    'Some selected file types (like .bat, .sh, .ps1) may interfere with normal system operations. Use with caution.',
