export const fileViewer = {
  ...
  'pcd.error.binaryNotSupported': '当前暂不支持二进制格式的PCD文件',
  'pcd.error.noValidPoints': '未找到有效的点云数据',
  'pcd.error.loadFailed': '加载PCD文件失败',
  'pcd.hideStats': '隐藏统计',
  'pcd.showStats': '显示统计',
  'pcd.settings': '设置',
  'pcd.stopRotation': '停止旋转',
  'pcd.startRotation': '开始旋转',
  'pcd.resetView': '重置视图',
  'pcd.zoomIn': '放大',
  'pcd.zoomOut': '缩小',
  'pcd.statistics': '统计信息',
  'pcd.pointCount': '点数量',
  'pcd.hasColor': '包含颜色',
  'pcd.hasIntensity': '包含强度',
  'pcd.bounds': '边界',
  'pcd.renderSettings': '渲染设置',
  'pcd.pointSize': '点大小',
  'pcd.colorMode': '颜色模式',
  'pcd.colorMode.rgb': 'RGB颜色',
  'pcd.colorMode.intensity': '强度',
  'pcd.colorMode.height': '高度',
  ...
  'pcd.pointsLimited': '仅显示前 {{maxPoints}} 个点 (共 {{totalPoints}} 个)',
};
